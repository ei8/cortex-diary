...
using works.ei8.Cortex.Diary.Port.Adapter.UI.Reactive.ViewModels.Peripheral;
using Splat;

namespace works.ei8.Cortex.Diary.Port.Adapter.UI.Reactive.ViewModels.Docking
{
